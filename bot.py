...
async def Lazy_start():
    print('\n')
    print('Initalizing Hell King Bot')
    ...
    for name in files:
        with open(name) as a:
            ...
            print("Hell King Imported => " + plugin_name)
    if ON_HEROKU:
    ...
    await LazyPrincessBot.send_message(chat_id=chat.id, text=script.RESTART_TXT.format(today, time))
